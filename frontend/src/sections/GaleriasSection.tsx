...
export function GaleriasSection() {
  return (
    <SectionShell id="galerias" className="bg-white">
      ...
      <Reveal delay={0.05} className="mt-20">
        <h2 className="text-enel-navy text-3xl font-semibold tracking-tight md:text-4xl">
          Descubre al equipo
        </h2>
              ...
              <div className="relative grid gap-8 md:grid-cols-[1.2fr_0.8fr] md:items-center">
                <div>
                  ...
                  <a
                    ...
                    className="bg-enel-pink hover:bg-enel-pink/80 border-enel-pink mt-6 inline-flex items-center gap-2 rounded-full border-2 px-5 py-2.5 text-sm font-semibold text-white transition"
                  >
