    ...
    <section id="historia" className="bg-white py-20 md:py-28">
      <div className="mx-auto w-full max-w-6xl px-5 md:px-8">
        <Reveal className="mx-auto max-w-3xl text-center">
          <p className="text-enel-red text-sm font-semibold tracking-[0.2em] uppercase">Historia</p>
          ...
          <p className="mt-5 text-base leading-relaxed text-neutral-600 md:text-lg">
            Enel Chile S.A. es uno de los holdings eléctricos más importantes de Chile, constituido
            en 2016 y parte de Enel SpA, compañía multinacional presente en más de 30 países. Enel
            Distribución Chile es la empresa de distribución de energía eléctrica más grande del
            país.
          </p>
        ...
        <Reveal delay={0.15} className="mt-16">
          <div className="bg-enel-navy rounded-3xl p-8 md:p-12">
            <p className="text-center text-sm font-semibold tracking-[0.2em] text-white/50 uppercase">
              En números
            </p>
