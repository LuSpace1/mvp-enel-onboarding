    ...
    <div className="relative aspect-video w-full overflow-hidden rounded-2xl bg-black">
      {reproducir ? (
        ...
        >
          ...
          />
          <span className="group-hover:bg-enel-blue relative flex h-16 w-16 items-center justify-center rounded-full bg-white/90 text-black shadow-xl transition duration-300 group-hover:scale-110 group-hover:text-white">
